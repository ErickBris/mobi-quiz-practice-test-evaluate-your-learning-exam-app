...
import com.mobiquiz.font.RobotoItalicTextView;
...
class CompletedQuilzListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			viewHolder.title = (com.mobiquiz.font.RobotoMediumTextView) v.findViewById(R.id.quizname);
			viewHolder.categoryname = (com.mobiquiz.font.RobotoMediumTextView) v.findViewById(R.id.categoryname);

			viewHolder.titlefirstletter=(com.mobiquiz.font.RobotoMediumTextView) v.findViewById(R.id.item_letter);
			viewHolder.noofattempts = (com.mobiquiz.font.RobotoMediumTextView) v.findViewById(R.id.noofattempts);
			viewHolder.score = (com.mobiquiz.font.RobotoMediumTextView) v.findViewById(R.id.score);
	...
	static class ViewHolder {
		com.mobiquiz.font.RobotoMediumTextView title,titlefirstletter,noofattempts,score,categoryname;
